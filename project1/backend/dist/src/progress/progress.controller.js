...
const complete_lecture_dto_1 = require("./dto/complete-lecture.dto");
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '강의 단위 완료 처리' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, complete_lecture_dto_1.CompleteLectureDto]),
    __metadata("design:returntype", void 0)
], ProgressController.prototype, "completeLecture", null);
__decorate([
    (0, common_1.Get)('course/:courseId'),
    (0, swagger_1.ApiOperation)({ summary: '강의 진도 조회' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
